...
/**
 * Fetches title + author from YouTube oEmbed — the only endpoint that reliably
 * serves video metadata to servers without cookies (the watch page returns a
 * consent interstitial to bots, whose generic description leaks into previews).
 * Fast single request; falls back gracefully on failure.
 */
