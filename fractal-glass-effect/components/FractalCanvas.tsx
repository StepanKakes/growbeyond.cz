...
export const FractalCanvas: React.FC = () => {
  ...
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden bg-[#2a2a2a]">
      ...
      <motion.div
        ...
        style={{
          ...
          background: 'linear-gradient(180deg, #D4D4D4 0%, #9CA3AF 40%, #4B5563 100%)',
          filter: 'blur(80px)',
          opacity: 0.6
        }}
      />
      ...
      <motion.div 
        ...
        style={{
          ...
          background: 'linear-gradient(180deg, #E5E5E5 0%, #FF4444 20%, #FF0E00 50%, #2a2a2a 100%)',
          opacity: 0.9,
          filter: 'blur(80px)',
          boxShadow: '0px -20px 100px -10px rgba(255, 14, 0, 0.5)'
        }}
      />
      ...
      */}
      <div className="blender absolute inset-0 w-full h-full pointer-events-none" />
